...
else
{
	...
	<footer><div class='lol'>
	<div style='margin: 0; display: inline-block; font-size: 0px; height: 50px;'>
		<img src='http://pbs.twimg.com/profile_images/571147898500603905/WS3SXytK.jpeg' style='display: inline-block; height: 50px; width: 50px; border-radius: 100%;'/>
		<div style='height: 50px; display: inline-block; font-size: 0px; padding-left: 10px; vertical-align: top;'>
			<ul style='list-style-type: none; margin: 0; padding: 0; font-size: 0px; height: 50px;	'>
				<li style='line-height: 22px; font-size: 16px; font-weight: 400; color: #1F1F21;'>Daniel Fanara</li>
				<li style='font-size: 12px; line-height: 17px; font-weight: 300; font-style: italic; color: #8E8E8E;'>@fanieldanara</li>
			</ul>
		</div>
	</div>
	</div></footer>
